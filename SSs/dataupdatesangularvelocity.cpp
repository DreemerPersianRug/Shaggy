...
DataUpdatesAngularVelocity::DataUpdatesAngularVelocity(QVector<QLabel*>& labels)
    : labels__(labels)
{
...
void DataUpdatesAngularVelocity::update(const QVector<QString>& values, bool use_blank, bool use_rad, bool use_deg)
{
